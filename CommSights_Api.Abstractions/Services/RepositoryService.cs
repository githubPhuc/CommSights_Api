...
using static CommSights_Api.Library.Helps.ObjectHelper;

namespace CommSights_Api.Abstractions.Services
{
    public class RepositoryService<T> : IRepository<T> where T : BaseModel
    {
        private readonly CommSightsContext _context;

        public RepositoryService(CommSightsContext context)
        {
            _context = context;
        }
